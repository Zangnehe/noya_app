...
//         if (selectedPriceFilter == '300k - 500k')
//           return price >= 300000 && price <= 500000;
//         if (selectedPriceFilter == 'Trên 500k') return price > 500000;
//         return true;
//       }).toList();
//     }
...
//       filtered = filtered.where((product) {
//         final brand = product['brand']?.toString().toLowerCase() ?? '';
//         return brand == selectedBrandFilter.toLowerCase();
//       }).toList();
//     }
...
//                           ),
//                         ),
//                         onChanged: (_) => setState(() {}), // ✅ tách riêng
//                         onSubmitted: (value) {
//                           final keyword = value.trim();
...
//                                       crossAxisCount: 2,
//                                       mainAxisExtent:
//                                           360, // ✅ chiều cao card khớp với SearchResultCard
//                                       crossAxisSpacing: 12,
//                                       mainAxisSpacing: 12,
//                                     ),
//                                 itemBuilder: (context, index) {
