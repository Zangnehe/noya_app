...
class _NewProductsPageState extends State<NewProductsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredProducts = newProducts.where((product) {
      ...
      final promotionEndStr = product['promotionEnd']?.toString();
      DateTime? promotionEnd;
      if (promotionEndStr != null && promotionEndStr.isNotEmpty) {
        promotionEnd = DateTime.tryParse(promotionEndStr);
      }
      final promotionValid =
          promotionEnd == null || promotionEnd.isAfter(DateTime.now());

      final discountMatch =
          (!showDiscountOnly || isDiscounted) && promotionValid;
