...
//                       Text('Giá gốc: ${formatCurrency(cart.subtotal)}'),
//                       if (cart.discountPercent > 0)
//                         Text('Giảm giá: -${(cart.discountPercent * 100).toInt()}%'),
//                       Text('Thuế (8%): ${formatCurrency(cart.tax)}'),
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('🗑️ Đã xóa toàn bộ giỏ hàng'),
                      ...
                      return Card(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Checkbox(
                                value: cart.selectedItemIds.contains(item.id),
                                onChanged: (_) =>
