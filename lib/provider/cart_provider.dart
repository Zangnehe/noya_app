...
// import '../models/user_address.dart'; // ✅ chỉ import, không định nghĩa lại
...
//     _shippingFee = 0; // ✅ reset phí ship khi thêm địa chỉ mới
//     saveAddresses();
//     notifyListeners();
//   }
...
//       }
//       _shippingFee = 0; // ✅ reset phí ship khi sửa địa chỉ
//       saveAddresses();
//       notifyListeners();
//     }
//   }
...
//     }
//     _shippingFee = 0; // ✅ reset phí ship khi xóa địa chỉ
//     saveAddresses();
//     notifyListeners();
//   }
...
//     _shippingFee = 0; // ✅ reset phí ship khi chọn địa chỉ khác
//     notifyListeners();
//   }
...
//     }
//     _shippingFee = 0; // ✅ reset phí ship khi đổi chi nhánh
//     notifyListeners();
//   }
...
//     // ✅ chỉ tính khoảng cách nếu có đủ lat/lng
//     if (_selectedAddress?.lat == null ||
//         _selectedAddress?.lng == null ||
//         branchLat == null ||
//         branchLng == null) {
...
//       'status': 'pending', // ✅ để pending, cập nhật sau khi thanh toán
//       'note': orderNote,
