...
//   final Map<String, String>? specs; // Thông số kỹ thuật
//   final List<String>? ingredients; // Thành phần
//   final String? usage; // Hướng dẫn sử dụng
...
//     if (isPromotionValid && discountPrice != null) {
...
//     if (discountPrice != null && originalPrice != null && originalPrice! > 0) {
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      ingredients: json['ingredients'] != null
          ...
          : null,
      usage: json['usage']?.toString(),
      skinTypeTags: json['skinTypeTags'] != null
          ? List<String>.from(json['skinTypeTags'] as List)
          : null,
      skinConcerns: json['skinConcerns'] != null
          ? List<String>.from(json['skinConcerns'] as List)
          : null,
      recommendationScore: json['recommendationScore'] as int?,
      ageGroup: json['ageGroup'] != null
          ? List<String>.from(json['ageGroup'] as List)
          : null,
      quantity: (json['quantity'] as int?) ?? 1,
    );
  }
  ...
  factory Product.fromMap(Map<String, dynamic> map) {
    return Product(
      ...
      ingredients: map['ingredients'] != null
          ...
          : null,
      usage: map['usage']?.toString(),
      skinTypeTags: map['skinTypeTags'] != null
          ? List<String>.from(map['skinTypeTags'] as List)
          : null,
      skinConcerns: map['skinConcerns'] != null
          ? List<String>.from(map['skinConcerns'] as List)
          : null,
      recommendationScore: map['recommendationScore'] as int?,
      ageGroup: map['ageGroup'] != null
          ? List<String>.from(map['ageGroup'] as List)
          : null,
      quantity: (map['quantity'] as int?) ?? 1,
    );
  }
  ...
  Product copyWith({
    ...
    return Product(
      ...
      ingredients: ingredients ?? this.ingredients,
      usage: usage ?? this.usage,
      skinTypeTags: skinTypeTags ?? this.skinTypeTags,
  ...
  String toString() {
    return 'Product(id: $id, name: $name, brand: $brand, type: $type, '
        ...
        'description: $description, specs: $specs, '
        'ingredients: $ingredients, usage: $usage, '
        'skinTypeTags: $skinTypeTags, skinConcerns: $skinConcerns, '
        'recommendationScore: $recommendationScore, ageGroup: $ageGroup, '
        'quantity: $quantity)';
  }
}
